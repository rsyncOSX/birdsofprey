...
I have also included some photos of the White-tailed eagle, photographed in the western part of Norway. The White-tailed eagle is the largest bird of prey in Norway, and it is truly huge.
...
I also have a Zeiss Secacam 5 trail camera. Some of the videos of the Hen Harrier that I've taken are actually from the Zeiss.
...
I'm quite new to shooting video. The Sony footage is captured at 100 frames per second in 4K resolution, with a shutter speed of 1/200s, following the 180-degree rule. The picture profile is Sony S-Log3. In DaVinci Resolve, I apply the Color Space Transform from S-Log3 to Rec.709. The videos from the Zeiss Secacam are standard MP4 videos in 1080p format using the Rec.709 color space.

# About this site

Hugo, a static site generator, builds these pages. The gallery is built with [Gallery Deluxe](https://github.com/bep/gallerydeluxe), an open-source project hosted on GitHub. Netlify automatically detects changes to the main branch and rebuilds the server in seconds.
